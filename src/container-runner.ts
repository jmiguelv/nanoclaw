...
async function buildContainerArgs(
  ...
  // Skip OneCLI when using OAuth: OneCLI injects ANTHROPIC_API_KEY=placeholder which
  // Claude Code validates locally before any API call, causing "Invalid API key" errors.
